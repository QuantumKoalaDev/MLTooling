...
MLTOOLING_CAPI void lr_destroy(LinearRegressionModel* m)
{
    delete m;
}

MLTOOLING_CAPI void lr_fit(
    LinearRegressionModel* model, Mat* mat, float* yData, unsigned int yDataLength, float learningRate,
    unsigned int epochs
)
{
